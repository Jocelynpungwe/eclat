...
const Hero = () => {
  return (
    <section className="relative hero-bg text-white flex flex-col text-center items-center justify-center h-[80vh] mt-[5rem]">
      <div className=" absolute w-full h-full top-0 left-0  bg-opacity-70 bg-black"></div>
      <article className="z-[1] w-[90%]">
        <h1 className="text-[1.2rem] md:text-[2rem] tracking-wide mb-[1rem] font-bold">
          Trust the Cleaning Experts to Shine Your Space
        </h1>
        <p className="text-[1rem] md:text-[1.5rem] tracking-wide mb-[2rem]">
